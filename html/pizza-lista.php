...
<tr>
    ...
    <td><a class="btn-dell" href="../backend/deletar-pizza.php?id=<?php echo $pizza ['id'];?>">DELETAR</a>
    <a class="btn-edit" href="editar-pizza.php?id=<?php echo $pizza ['id'];?>">EDITAR</a></td>
</tr>                    
<?php endforeach;?>
